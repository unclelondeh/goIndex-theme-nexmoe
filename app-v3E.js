 ...
 */
// 在head 中 加载 必要静态
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.3/css/mdui_v2.min.css">');
document.write('<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.4/css/nexmoe_v2.min.css">');
document.write('<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.3/js/mdui.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.5/js/flv.min.js"></script>');
document.write('<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.5/js/DPlayer.min.js"></script>');
// markdown支持
document.write('<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe@1.1.3/js/markdown-it.min.js"></script>');
...
<header class="nexmoe-nav">
	<div class="navSize">
			<a href="/"><img class="avatar" src="https://img.icons8.com/color/48/000000/batman-old.png"/></a>
			<div class="nav_menu">
				<ul class="menu_ul">
					<li class="menu_li"><a href="https://drive.google.com/drive/u/1/mobile/my-drive" target="_blank">MyDrive</a></li>
					<li class="menu_li"><a href="https://fast.com" target="_blank">SpeedTest</a></li>
				</ul>
...
function title(path) {
  ...
  if (model.is_search_page)
    $('title').html(`${document.siteName} - ${drive_name} - Search ${model.q} Results`);
  else
      ...
      if (window.scroll_status.event_bound !== true) {
        ...
        $(window).on('scroll', function () {
          ...
          if (scrollTop + windowHeight > scrollHeight - (Os.isMobile ? 130 : 80)) {
            /*
                When the roll to the bottom event is triggered, ignore the event if it is already in the loading；
            ...
            requestListPath(path, {
              ...
              // The password is the same as before. Does not appear authError
              null
            )
          }
        });
...
function onSearchResultItemClick(a_ele) {
  ...
  $.post(`/${cur}:id2path`, {id: a_ele.id}, function (data) {
    ...
    dialog = mdui.dialog({
      ...
      content: 'o(╯□╰)o Maybe it doesnt exist in the plate.！Or maybe its because theres no【Share with me】files added to Personal Drive！',
      history: false,
      modal: true,
      closeOnEsc: true,
      buttons: [
...
<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe/js/ace.js"></script>
<script src="//cdn.jsdelivr.net/gh/unclelondeh/goIndex-theme-nexmoe/js/ext-language_tools.js"></script>
	`;
  $('#content').html(content);
...
<a href="${url}" class="mdui-fab mdui-fab-fixed mdui-ripple mdui-color-theme-accent"><i class="mdui-icon material-icons">file_download</i></a>
  ...
  $('#copy-link').on('click', () => {
    copyToClipboard(url);
    mdui.snackbar('Copied to the clipping board!');
  });
